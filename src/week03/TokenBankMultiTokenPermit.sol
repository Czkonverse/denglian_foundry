...
contract TokenBankMultiTokenPermit {
    ...
    function depositWithPermit2(
        ...
        // 验证转账金额大于0
        if (transferDetails.requestedAmount == 0) revert TokenBank__AmountMustBeGreaterThanZero();
        
        // 验证接收地址是本合约
        if (transferDetails.to != address(this)) revert TokenBank__InvalidSpender();
        ...
        // 更新存款金额
        s_deposits[msg.sender][permit.permitted.token] += transferDetails.requestedAmount;
